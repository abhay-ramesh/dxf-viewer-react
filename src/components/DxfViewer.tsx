...
export const DxfViewer: React.FC<DxfViewerProps> = ({ dxfContent }) => {
  ...
  const processCircle = (entity: any, material: THREE.Material) => {
    if (!entity.center || !entity.radius) return null;
  ...
  const processPolyline = (entity: any, material: THREE.Material) => {
  ...
  const processSpline = (entity: any, material: THREE.Material) => {
